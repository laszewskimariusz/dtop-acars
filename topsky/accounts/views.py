...
def register_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Utwórz profil SmartCARS dla nowego użytkownika - commented for debugging
            # try:
...
def dashboard_view(request):
    # Pobierz lub utwórz profil SmartCARS użytkownika - commented for debugging
    # try:
    #     from acars.models import SmartcarsProfile
    ...
    context = {
        'user': request.user,
        # 'smartcars_profile': smartcars_profile  # Commented for debugging
    }
